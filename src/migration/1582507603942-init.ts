...
export class init1582507603942 implements MigrationInterface {
    name = 'init1582507603942'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `sign` (`id` int NOT NULL AUTO_INCREMENT, `url` varchar(255) NOT NULL, `userId` int NOT NULL, UNIQUE INDEX `IDX_b52969fde4e270bdb8a76a97c4` (`url`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
